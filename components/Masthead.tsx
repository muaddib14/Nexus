...
export default function Masthead({ activeTab, setActiveTab }: MastheadProps) {
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#100E0A]/95 backdrop-blur-md border-b border-[rgba(233,227,213,0.18)]">
      ...
      <div className="border-t border-[rgba(233,227,213,0.1)] bg-[#17140E]/80">
        <div className="max-w-[920px] mx-auto grid grid-cols-2 sm:grid-cols-5 text-xs font-mono divide-x divide-[rgba(233,227,213,0.1)] border-b sm:border-b-0 border-[rgba(233,227,213,0.1)]">
          <div className="px-6 py-2 flex flex-col gap-0.5">
            <span className="text-[9.5px] tracking-[0.16em] text-[#9A9385] uppercase">filed today</span>
            <span className="text-sm font-semibold text-[#E9E3D5]">07</span>
          </div>
          <div className="px-6 py-2 flex flex-col gap-0.5">
            <span className="text-[9.5px] tracking-[0.16em] text-[#9A9385] uppercase">leads found</span>
            <span className="text-sm font-semibold text-[#E9E3D5]">19</span>
          </div>
          <div className="px-6 py-2 flex flex-col gap-0.5">
            <span className="text-[9.5px] tracking-[0.16em] text-[#9A9385] uppercase">leads killed</span>
            <span className="text-sm font-semibold text-[#D64A3A]">12</span>
          </div>
          <div className="px-6 py-2 flex flex-col gap-0.5">
            <span className="text-[9.5px] tracking-[0.16em] text-[#9A9385] uppercase">spent today</span>
            <span className="text-sm font-semibold text-[#E9E3D5]">
              $3.87 <span className="text-[#9A9385] font-normal text-xs">/ 10.00</span>
            </span>
          </div>
          <div className="px-6 py-2 flex flex-col gap-0.5 col-span-2 sm:col-span-1">
            <span className="text-[9.5px] tracking-[0.16em] text-[#9A9385] uppercase">uplink status</span>
